...
import { HydrateClient } from '@/trpc/rq-server';
...
const Appointments = async (props: { searchParams?: { [key: string]: string | string[] | undefined } }) => {
    ...
    try {
        // Pass numeric page
        appointmentsResponse = (await caller.appointment.getPatientAppointments({
            page: safePage,
            search: searchQuery,
            id: queryId,
            limit: DATA_LIMIT
