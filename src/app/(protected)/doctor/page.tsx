...
const DoctorDashboard = async () => {
    ...
    const rawAvailableDoctors = await caller.doctor.getAvailableDoctors();
    ...
    const { totalPatient, totalNurses, totalAppointment, appointmentCounts, monthlyData, last5Records } =
        await caller.doctor.getDoctorDashboardStats();
